...
namespace HyperNetworking.Messaging
{
    ...
    /// <summary>
    /// <para>Marks a method as SharedRpc.</para>
    /// <para>A SharedRpc marked method will can be fired by everyone and but executed on the specified target(s).</para>
    /// </summary>
    [AttributeUsage(AttributeTargets.Method)]
    public class SharedRpcAttribute : RpcAttribute { }
